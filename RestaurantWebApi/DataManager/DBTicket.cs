...
namespace RedDot
{
    public class DBTicket
    {
        ...
        public int DBCreateTicketQS(int employeeid, int tablenumber, OrderType ordertype, SubOrderType subordertype, int stationno)
        {
            ...
            _dbconnect.Command("Insert into sales(employeeid,status,tablenumber,ordertype,subordertype,stationno) values (" + employeeid + ",'Open'," + tablenumber + ",'" + ordertype.ToString() + "','" + subordertype.ToString() + "'," + stationno + ")");
        ...
        public bool DBInsertPayment(int salesid, string paytype, decimal amount, decimal netamount, string authorizationCode, string cardtype, string maskedpan, decimal tip, DateTime paymentdate, string transtype)
        {
            string querystring = "";
            ...
            querystring = "Insert into payment (salesid,cardgroup,  amount,netamount, authorcode,cardtype,maskedpan,tipamount,paymentdate,transtype) values (" + salesid + ",'" + paytype + "'," + amount + "," + netamount + ",'" + authorizationCode + "','" + cardtype + "','" + maskedpan + "'," + tip + ",'" + paymentdate.ToString("yyyy-MM-dd HH:mm:ss") + "','" + transtype + "')";
            return _dbconnect.Command(querystring);
        }
