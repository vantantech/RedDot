...
namespace TriPOS.ResponseModels
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot("BatchItemQueryResponse", Namespace = "https://transaction.elementexpress.com")]
    [DataContract(Name = "BatchItemQueryResponse")]
    public class BatchItemQueryResponse
    {
