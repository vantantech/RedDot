...
{
    [Serializable]
    [XmlRoot("authorizationCompletionResponse", Namespace = "http://tripos.vantiv.com/2014/09/TriPos.Api")]
    [DataContract(Name = "authorizationCompletionResponse")]
    public class AuthorizationCompletionResponse
    {
