...
namespace TriPOS.ResponseModels
{
    ...
    /// </summary>
    [Serializable]
    [XmlRoot("BatchTotalsQueryResponse", Namespace = "https://transaction.elementexpress.com")]
    [DataContract(Name = "BatchTotalsQueryResponse")]
    public class BatchTotalsQueryResponse
    {
