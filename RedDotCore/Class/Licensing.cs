    ...
    public class Licensing
    {
        ...
        public static bool CheckPermission(string permission)
        {
            ...
            try
            {
                ...
                permissionstring = Decrypt(License.LoadEncryptedPermission(), _privateKey2);
        ...
        public static bool CheckLicense()
        {
            try
            {
                ...
                //decrypt string using private key2
                //get license info
                licensestring = Decrypt(License.LoadEncryptedLicense(), _privateKey2);
             


               // string[] licensearry = licensestring.Split(':');

                if (licensestring != FingerPrint.Value())
                {
                    Utility.Alert("License not valid for this machine");
                    CreateMachineFile();
                    return false;
