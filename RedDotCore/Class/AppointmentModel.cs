...
namespace RedDot
{
    public class AppointmentModel
    {
        ...
        public ObservableCollection<AppointmentGroup>  GetDailyAppointments(DateTime appointmentdate, int NumOfColumn)
        {
            ...
            employeelist =  m_dbemployee.GetEmployeeActive(); 
        ...
        public int CreateNewAppt(Appointment appt)
        {
            ...
            return dbappt.CreateNewAppointment(appt.ApptDate, appt.CurrentEmployee.ID, customerid, appt.Length, appt.Note, appt.CatID);
