...
namespace RestaurantService
{
    ...
    {
        private const string Unique = "RestaurantService"; //use to create single instance rule
       ...
       // SalonWebClient m_webclient;
        ...
        public static void Main()
        {
            ...
            else
            {
                ...
                Confirm conf = new Confirm("Restaurant Service is already running.  Kill current app and run new instance?");
                conf.ShowDialog();
                if (conf.Action.ToUpper() == "YES")
                {
                    foreach (var process in Process.GetProcessesByName("RestaurantService"))
                    {
        ...
        private void Application_Startup(object sender, StartupEventArgs e)
        {
            ...
            _notifyIcon.Icon = RestaurantService.Properties.Resources.restaurantsync;
            ...
            try
            {
                ...
                if ((DateTime.Now - lastdailysynced).TotalHours > 24)
                {
                    ...
                    try
                    {
                        ...
                        logger.Debug("checking:" + lastdailysynced);
        ...
        */
        ...
        private void DBBackup()
        {
            try
            {
                ...
                logger.Debug("DBBackup started ...");

                string backupdirectory = Directory.GetCurrentDirectory() + GlobalSettings.Instance.BackupDirectory;
