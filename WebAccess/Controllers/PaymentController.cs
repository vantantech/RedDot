        ...
        public ActionResult Index(int? reporttype, int? StoreId, string startdate, string enddate)
        {
            ...
            if (defaultstore != null)
            {
                ...
                var tips = (from s in context.sales
                             ...
                             join empsub in (from emp in context.employees where emp.userid == webid select emp ) on s.employeeid equals empsub.employeeid into ps from e in ps.DefaultIfEmpty()
