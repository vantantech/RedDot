...
namespace RedDot
{
    ...
    public class RetailLineItem : INPCBase
    {
        ...
        public RetailLineItem(string description)
        {
            ID = 0;
        ...
        public RetailLineItem(DataRow row, decimal commissionproduct, decimal commissionlabor, bool salesrep)
        {
            ...
            try
            {
                ...
                else
                {
                    if (ItemType == "product")
                    {
                        CommissionRate = commissionproduct;
                    }


                    if (ItemType == "service")
                    {
                        CommissionRate = commissionlabor;
                    }
                }
