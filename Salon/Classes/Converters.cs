...
namespace RedDot
{
    ...
    public class StringToColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (value.ToString().Contains("[empty]")) return "Red";
    ...
    public class BalanceToBackgroundConverter : IValueConverter
    {
        public object Convert(object value, Type targetType, object parameter, System.Globalization.CultureInfo culture)
        {
            ...
            if (decimal.Parse(value.ToString()) == 0) return "";

            if (decimal.Parse(value.ToString()) != 0) return "Yellow";
    ...
    public class ResizeConverter2 : IValueConverter
    {
